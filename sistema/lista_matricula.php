...
<body>
	...
	<section id="container">
        ...
        <a href="reportes/reporte_matriculas.php" class="btn_new"><i class="fas fa-print"></i> Imprimir listado</a>
        <!--buscador en lista-->
        
        <form action="buscar_matricula.php" method="get" class="form_search">
        <input type ="text" name="busqueda" id="busqueda" placeholder="No. Boleta">
            ...
            <table>
                ...
                <?php
                    ...
                    $query_register = mysqli_query($conection, "SELECT COUNT(*) AS total_register FROM boleta WHERE estado != 3");
