...
<head>
	<meta charset="UTF-8">
	<title>Reporte de Catedraticos</title>
...
<body>
	<table class="cabecera">
		<tr>
			...
			<td>
				<div>
					<h1 class="titulo">Reporte de Catedraticos activos en la plataforma</h1><br>
				</div>
			</td>
		</tr>
...
$dompdf->stream('Reporte_catedraticos.pdf', array("Attachment" => false));
